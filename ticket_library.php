    ...
    if (isset($_POST['Search'])) {
        ...
        if ($_POST) {
            ...
            if (!empty($_POST['searchid'])) {
                ...
                $select = mysqli_query($connection, "SELECT movies.movie_id, movies.name , ticket.ticket_id , ticket.ticket_total , ticket.ticket_left ,ticket.price,ticket.datetime from movies JOIN ticket ON movies.movie_id=ticket.movie_id where movies.name = '$name'") or die(mysqli_error($connection));
            } else {
                $select = mysqli_query($connection, "SELECT movies.movie_id, movies.name , ticket.ticket_id , ticket.ticket_total , ticket.ticket_left ,ticket.price,ticket.datetime from movies JOIN ticket ON movies.movie_id=ticket.movie_id");
            }
        } else {
